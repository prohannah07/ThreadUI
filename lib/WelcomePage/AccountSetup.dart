...
class _AccountSetupState extends State<AccountSetup>{
  ...
  Widget _accountSignInButton(String socailMediaName, String socialMediaImagePath){
    return Container(
      width: 370.0,
      height: 70,
      child: ButtonTheme(
          ...
          child: Row(
            children: <Widget>[
                ...
                children: <TextSpan>[
                    ...
                    TextSpan(text: "$socailMediaName", style: TextStyle(fontWeight: FontWeight.bold))
                  ],
                ),
              ),
            ],
    ...
    return Scaffold(
      body: Container(
        ...
        child: Column(children: <Widget>[
            Container(height: 130.0, width: double.infinity,),
            _accountLoginTitle(),
